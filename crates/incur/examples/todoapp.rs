...
//!   cargo run -p incur --example todoapp -- list
//!   cargo run -p incur --example todoapp -- list --status done
//!   cargo run -p incur --example todoapp -- get 1
//!   cargo run -p incur --example todoapp -- complete 1
//!   cargo run -p incur --example todoapp -- stats
//!   cargo run -p incur --example todoapp -- stream
//!   cargo run -p incur --example todoapp -- list --json
//!   cargo run -p incur --example todoapp -- list --format yaml
//!   cargo run -p incur --example todoapp -- --version
...
use incur::middleware::{BoxFuture, MiddlewareContext, MiddlewareFn, MiddlewareNext};
use incur::output::{CommandResult, CtaBlock, CtaEntry};
