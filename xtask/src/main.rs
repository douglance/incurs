...
fn release_packages() -> Vec<(Workspace, String, String)> {
    [
        ...
        (Workspace::Root, "incurs", "0.9.0"),
        (Workspace::Root, "incurs-cli", "0.9.0"),
        (Workspace::Root, "incurs-extras", "0.9.0"),
        (Workspace::Root, "incurs-codemode", "0.7.0"),
        (Workspace::Root, "incurs-codemode-local", "0.7.0"),
        (Workspace::Root, "incurs-codemode-mcp", "0.7.0"),
        (Workspace::Root, "incurs-mcp-protocol", "0.2.0"),
        (Workspace::Root, "incurs-mcp-discovery", "0.1.1"),
        (Workspace::Root, "incurs-mcp-client", "0.5.0"),
        (Workspace::Root, "incurs-mcp-registry", "0.5.0"),
        (Workspace::Root, "incurs-remote", "0.5.0"),
        (Workspace::Root, "incurs-app-model", "0.4.0"),
        (Workspace::Root, "incurs-app-ratatui", "0.4.0"),
        (Workspace::Cloudflare, "incurs-codemode-cloudflare", "0.7.0"),
        (Workspace::Cloudflare, "incurs-mcp-cloudflare", "0.5.0"),
    ]
    .into_iter()
